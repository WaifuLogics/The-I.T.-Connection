...
-- Dumping data for table it_connection.authorization: ~2 rows (approximately)
/*!40000 ALTER TABLE `authorization` DISABLE KEYS */;
INSERT INTO `authorization` (`auth_code`, `auth_user`, `user_password`, `auth_time`) VALUES
	('2949', 'user_551', '$2y$10$Q/.1wFW9MzA3CgP.HOtPHejjr90XTNY7WSU/KY21Do5bpTljKYwOC', '2018-05-14 12:47:46');
...
-- Dumping data for table it_connection.users: ~2 rows (approximately)
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
INSERT INTO `users` (`user_id`, `user_firstname`, `user_lastname`, `user_email`) VALUES
	('user_551', 'unset', 'unset', '123');
